                    ...
                    <div class="section-inner panel">
                        <div class="row child-cols-12 lg:child-cols-6 items-center g-2 lg:g-4" data-anime="targets: >*; translateY: [48, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: anime.stagger(100, {start: 200});">
                            <div class="panel vstack gap-narrow lg:gap-2">
                                <h1 class="fs-6 fw-bold text-muted">Tally on Cloud – Access Your Business Anytime, Anywhere</h1>
                                <p class="h2 md:h1 lg:display-6 xl:display-3 xl:mb-2">Tally on Cloud</p>
                            </div>
                            <div class="panel">
                                <p class="fs-6 lg:fs-5 xl:fs-4 text-muted">Run Tally accounting software on secure cloud servers, enabling remote access and seamless usage over the internet.</p>
            ...
            <div class="section-outer panel py-4 md:py-6 xl:py-9">
                <div class="container max-w-xl">
                    <div class="section-inner panel max-w-800px mx-auto">
                        <h3>What is Tally on cloud?</h3>
                        <p class="fs-6 lg:fs-5 xl:fs-4 text-muted">
                            Tally on Cloud offers secure, remote access to your TallyPrime software, allowing you to manage accounting, GST compliance, inventory, banking, and reporting from any device. Hosted on reliable cloud servers, it eliminates the need for on-premise installations and lets you collaborate across branches, warehouses, or remote teams. Enjoy seamless updates, centralized data, and uninterrupted access to critical business information anytime, anywhere.
                        </p>
                        <!-- <p class="fs-6 lg:fs-5 xl:fs-4 text-muted">
                ...
                <div class="container sm:max-w-lg xl:max-w-xl">
                    <div class="section-inner panel">
                        <div class="panel vstack items-center gap-2 xl:gap-3 mb-4 lg:mb-8 max-w-650px mx-auto text-center" data-anime="onview: -100; targets: >*; translateY: [48, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: anime.stagger(100, {start: 200});">
                            <h2 class="h4 lg:h4 xl:h4 m-0">Modernize Your Accounting with Tally on Cloud</h2>
                            <p class="fs-6 lg:fs-5 xl:fs-4 text-muted">Upgrade your accounting practices and boost efficiency with Tally on Cloud, equipped with advanced features to simplify business management.</p>
                        </div>
                                        ...
                                        <div class="panel vstack justify-center gap-4 h-100">
                                            <div>
                                                <div class="panel vstack gap-2">
                                                    ...
                                                    <h3 class="h4 lg:h3 m-0">Remote Accessibility, Data Security & Scalability with <span class="text-blue">Tally on Cloud</span></h3>
                                                    <p class="fs-6 lg:fs-5 opacity-70 dark:opacity-80">Tally on Cloud empowers your team to work from anywhere, providing secure, real-time access to your accounting data and software via the internet. Advanced security measures—including encryption, firewalls, and regular data backups—ensure your financial data is always protected against unauthorized access. The cloud infrastructure also scales effortlessly, adapting to your evolving business needs. <br><br> <b>Key-Benefits:</b>
                                                        <ul class="fs-6 lg:fs-5 opacity-70 dark:opacity-80">
                                                            <li>Real-time collaboration among team members</li>
                                                            <li>Robust protection against unauthorized access and data loss</li>
                                                            <li>Quick and seamless scaling of cloud resources as your business grows</li>
                                                        </ul>
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="panel vstack justify-center gap-4 h-100">
                                            <div>
                                                <div class="panel vstack gap-2">
                                                    ...
                                                    <h3 class="h6 lg:h3 m-0">Cost Efficiency, Auto Updates & Multi-User Collaboration with <span class="text-blue">Tally on Cloud</span></h3>
                                                    <p class="fs-6 lg:fs-5 opacity-70 dark:opacity-80">Tally on Cloud eliminates hefty upfront costs with a flexible pay-as-you-go model, helping you manage your budget efficiently. Your software stays up-to-date automatically with the latest features, improvements, and bug fixes. Multiple team members can collaborate in real-time on the same data, ensuring smooth and efficient accounting processes.<br><br> <b>Key-Benefits:</b>
                                                        <ul class="fs-6 lg:fs-5 opacity-70 dark:opacity-80">
                                                            <li>Flexible pay-as-you-go model reduces upfront expenses</li>
                                                            <li>Automatic updates and patches keep your software current</li>
                                        ...
                                        <div class="panel vstack justify-center gap-4 h-100">
                                            <div>
                                                <div class="panel vstack gap-2">
                                                    ...
                                                    <h3 class="h4 lg:h3 m-0">Device Agnostic, Backup & Disaster Recovery with <span class="text-blue">Tally on Cloud</span></h3>
                                                    <p class="fs-6 lg:fs-5 opacity-70 dark:opacity-80">Tally on Cloud automatically secures your financial data with regular backups and robust disaster recovery, protecting your business from hardware failures or data corruption. Easily integrate with other business applications and add-ons to streamline processes and enhance functionality. With access from any device—desktop, laptop, tablet, or mobile—it offers unmatched flexibility in managing your accounting data.<br><br> <b>Key-Benefits:</b>
                                                        <ul class="fs-6 lg:fs-5 opacity-70 dark:opacity-80">
                                                            <li>Automatic data backups and disaster recovery</li>
                                                            <li>Seamless integration with business apps and add-ons</li>
                                                            <li>Real-time collaboration for multiple users</li>
                                                        </ul>
                                                    </p>
                                                </div>
