...
<head>
    ...
    <title>Enquiry | Tally Prime - Tally ERP 9 | Tally Solutions Business Software for SMBs in Chennai, Tamil nadu - UMAA Infotech</title>
...
<body class="uni-body panel bg-white text-gray-900 dark:bg-gray-900 dark:text-gray-200 overflow-x-hidden disable-cursor">
    ...
    <div id="wrapper" class="wrap">
                ...
                <div class="container max-w-xl">
                    <div class="section-inner panel mt-2 sm:mt-4 lg:mt-0" data-anime="targets: >*; translateY: [48, 0]; opacity: [0, 1]; easing: spring(1, 80, 10, 0); duration: 450; delay: anime.stagger(100, {start: 200});">
                        <div class="vstack items-center gap-2 lg:gap-4 mb-4 sm:mb-6 lg:mb-8 max-w-750px mx-auto text-center">
                            <h1 class="h2 sm:h1 lg:display-6 xl:display-5 m-0">Reach out to our team</h1>
                                ...
                                <div class="order-1 lg:order-0">
                                    <div class="panel overflow-hidden rounded-3 h-100 min-h-350px">
                                        <figure class="panel h-100 m-0 rounded ">
                                            ...
                                            <img class="media-cover image" src="./assets/images/umaainfotech-contactus-banner.webp" alt="Hero image">
                                        </figure>
                                            ...
                                            <!-- <div class="panel z-1">
                                                <div class="vstack gap-3">
                                                    ...
                                                    <div class="vstack gap-0">
                                                        <p class="fs-6 lg:fs-5 fw-medium">David Larry</p>
                                ...
                                <div class="order-0 lg:order-1">
                                    <form class="vstack gap-2 p-3 sm:p-6 xl:p-8">
                                        ...
                                        <div class="row child-cols-12 sm:child-cols-6 g-2">
                                            <div>
                                                <input class="form-control h-48px w-full bg-white dark:border-white dark:bg-opacity-10 dark:border-opacity-0 dark:text-white" type="text" placeholder="Full name" required="">
                                            </div>
                                            <div>
                                                <input class="form-control h-48px w-full bg-white dark:border-white dark:bg-opacity-10 dark:border-opacity-0 dark:text-white" type="tel" pattern="^\d{10}$" placeholder="Your Mobile number" required="">
                                            </div>
                                        </div>
                                        <input class="form-control h-48px w-full bg-white dark:border-white dark:bg-opacity-10 dark:border-opacity-0 dark:text-white" type="email" placeholder="Your email">

                                        <input class="form-control h-48px w-full bg-white dark:border-white dark:bg-opacity-10 dark:border-opacity-0 dark:text-white" type="text" placeholder="Address">

                                        <p class="h6">Company Info</p>
                                        <input class="form-control h-48px w-full bg-white dark:border-white dark:bg-opacity-10 dark:border-opacity-0 dark:text-white" type="text" placeholder="Company Name">

                                        <input class="form-control h-48px w-full bg-white dark:border-white dark:bg-opacity-10 dark:border-opacity-0 dark:text-white" type="text" placeholder="Industry">

                                        <input class="form-control h-48px w-full bg-white dark:border-white dark:bg-opacity-10 dark:border-opacity-0 dark:text-white" type="text" placeholder="Job Title">

                                        <p class="h6">Message</p>
                                        <textarea class="form-control min-h-150px w-full bg-white dark:border-white dark:bg-opacity-10 dark:border-opacity-0 dark:text-white" placeholder="Your message.." required=""></textarea>
                                        <button class="btn btn-primary btn-md text-white mt-2" type="submit">Send message</button>
                                        <p class="text-center">Or drop us a message via <a class="uc-link" href="mailto:info@umaainfotech.in">email</a>.</p>
                                    </form>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel vstack gap-4 sm:gap-6 xl:gap-8">
                            ...
                            <div class="row child-cols-12 sm:child-cols-6 lg:child-cols-3 g-2 xl:g-3 justify-between col-match" data-anime="onview: -100; targets: > *; translateY: [48, 0]; opacity: [0, 1]; easing: spring(1, 80, 10, 0); duration: 450; delay: anime.stagger(100, {start: 200});">
                                <div>
                                    <div class="panel vstack gap-2 items-center text-center px-3 py-4 lg:py-6 xl:py-8 rounded-2 bg-secondary dark:bg-gray-800 lg:hover:-translate-y-2 duration-150 transition-all">
                                        <div class="cstack mb-2">
                                            <img class="w-64px lg:w-80px d-block dark:d-none" src="./assets/images/template/icon-location.svg" alt="location-icon">
                                            <img class="w-64px lg:w-80px d-none dark:d-block" src="./assets/images/template/icon-location-dark.svg" alt="location-icon-dark">
                                        </div>
                                        <h5 class="h5 m-0">Visit us</h5>
                                        <p class="fs-6 opacity-70 dark:opacity-80">No.9, Linghi Chetty street, Chennai, Tamil Nadu -600 001</p>
                                        <a href="#" class="uc-link fw-bold hstack gap-narrow justify-center">
                                ...
                                <div>
                                    <div class="panel vstack gap-2 items-center text-center px-3 py-4 lg:py-6 xl:py-8 rounded-2 bg-secondary dark:bg-gray-800 lg:hover:-translate-y-2 duration-150 transition-all">
                                        <div class="cstack mb-2">
                                            <img class="w-64px lg:w-80px d-block dark:d-none" src="./assets/images/template/icon-chat.svg" alt="chat-icon">
                                            <img class="w-64px lg:w-80px d-none dark:d-block" src="./assets/images/template/icon-chat-dark.svg" alt="chat-icon-dark">
                                        </div>
                                        <h5 class="h5 m-0">Via Whatsapp</h5>
                                        <p class="fs-6 opacity-70 dark:opacity-80">Get instant Supprot from Whatsapp.</p>
                                        <a href="https://api.whatsapp.com/send?phone=918941001007" target=_blank class="uc-link fw-bold hstack gap-narrow justify-center">
                                ...
                                <div>
                                    <div class="panel vstack gap-2 items-center text-center px-3 py-4 lg:py-6 xl:py-8 rounded-2 bg-secondary dark:bg-gray-800 lg:hover:-translate-y-2 duration-150 transition-all">
                                        <div class="cstack mb-2">
                                            <img class="w-64px lg:w-80px d-block dark:d-none" src="./assets/images/template/icon-internet.svg" alt="internet-icon">
                                            <img class="w-64px lg:w-80px d-none dark:d-block" src="./assets/images/template/icon-internet-dark.svg" alt="internet-icon-dark">
                                        </div>
                                        <h5 class="h5 m-0">Report Issue</h5>
                                        <p class="fs-6 opacity-70 dark:opacity-80">Report Issue on <br> Mail support.</p>
                                        <a href="#" class="uc-link fw-bold hstack gap-narrow justify-center">
                                ...
                                <div>
                                    <div class="panel vstack gap-2 items-center text-center px-3 py-4 lg:py-6 xl:py-8 rounded-2 bg-secondary dark:bg-gray-800 lg:hover:-translate-y-2 duration-150 transition-all">
                                        <div class="cstack mb-2">
                                            <img class="w-64px lg:w-80px d-block dark:d-none" src="./assets/images/template/icon-community.svg" alt="community-icon">
                                            <img class="w-64px lg:w-80px d-none dark:d-block" src="./assets/images/template/icon-community-dark.svg" alt="community-icon-dark">
                                        </div>
                                        <h5 class="h5 m-0">Get Directions</h5>
                                        <p class="fs-6 opacity-70 dark:opacity-80">Get Location <br> for Live Visit</p>
                                        <a href="https://maps.app.goo.gl/fECyWRe4ZA67d3Xb6" target=_blank class="uc-link fw-bold hstack gap-narrow justify-center">
        ...
        <div class="py-4">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3885.9534711146134!2d80.29107719999999!3d13.1021342!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a526f577f0c300f%3A0x4a67878c8911b4c1!2sUmaa%20Infotech!5e0!3m2!1sen!2sin!4v1756128494473!5m2!1sen!2sin" width="100%" height="300px" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe> 
        </div>
        ...
        <div id="clients_brands" class="clients-brands section panel overflow-hidden">
            <div class="section-outer panel pb-8 sm:pb-9 xl:pb-9">
                <h5 class="h6 sm:h5 text-center mb-4 sm:mb-6 xl:mb-8" data-anime="onview: -100; translateY: [48, 0]; opacity: [0, 1]; easing: spring(1, 80, 10, 0); duration: 450; delay: 200;">Trusted by well-known brands.</h5>
                ...
                <div class="container max-w-xl">
                    <div class="section-inner panel">
                        <div class="panel vstack items-center gap-4 sm:gap-6 xl:gap-8" data-anime="onview: -100; targets: >*; translateY: [48, 0]; opacity: [0, 1]; easing: spring(1, 80, 10, 0); duration: 450; delay: anime.stagger(100, {start: 200});">
                                ...
                                <div class="row child-cols-12 sm:child-cols-6 lg:child-cols-4 justify-center g-2 xl:g-4">
                                    <div>
                                        <article class="post type-post panel vstack gap-3 rounded-3 p-2 pb-3 bg-white dark:bg-gray-800">
                                            <a class='position-absolute top-0 ltr:start-0 rtl:end-0 m-3 fs-7 fw-bold text-none z-1 bg-primary text-white py-narrow px-1' href='blog.html' style='border-radius: 8px;'>Strategy</a>
                                            <figure class="featured-image m-0 rounded ratio ratio-3x2 rounded-2 uc-transition-toggle overflow-hidden">
                                                <img class="media-cover image uc-transition-scale-up uc-transition-opaque" src="./assets/images/blog/img-11.jpg" alt="Top 5 reasons to invest in marketing">
                                                <a class='position-cover' data-caption='Top 5 reasons to invest in marketing' href='blog-details.html'></a>
                                            </figure>
                                            <header class="panel vstack items-center gap-1 lg:gap-2 px-2">
                                                <h3 class="h5 xl:h4 m-0 text-center m-0">
                                                    <a class='text-none' href='blog-details.html'>Top 5 reasons to invest in marketing</a>
                                                </h3>
                                                <ul class="post-meta nav-x ft-tertiary justify-center gap-1 fs-7 text-gray-400 dark:text-gray-300 d-none lg:d-flex">
                                                    <li>
                                                        <div class="hstack gap-narrow ft-tertiary ">
                                                            <img src="./assets/images/avatars/02.png" alt="David" class="w-24px h-24px rounded-circle me-narrow">
                                                            <a href="page-author.html" class="text-none fw-bold text-dark dark:text-white">David</a>
                                                        </div>
                                                    </li>
                                    ...
                                    <div>
                                        <article class="post type-post panel vstack gap-3 rounded-3 p-2 pb-3 bg-white dark:bg-gray-800">
                                            <a class='position-absolute top-0 ltr:start-0 rtl:end-0 m-3 fs-7 fw-bold text-none z-1 bg-primary text-white py-narrow px-1' href='blog.html' style='border-radius: 8px;'>Marketing</a>
                                            <figure class="featured-image m-0 rounded ratio ratio-3x2 rounded-2 uc-transition-toggle overflow-hidden">
                                                <img class="media-cover image uc-transition-scale-up uc-transition-opaque" src="./assets/images/blog/img-12.jpg" alt="How can marketing help your business?">
                                                <a class='position-cover' data-caption='How can marketing help your business?' href='blog-details.html'></a>
                                            </figure>
                                            <header class="panel vstack items-center gap-1 lg:gap-2 px-2">
                                                <h3 class="h5 xl:h4 m-0 text-center m-0">
                                                    <a class='text-none' href='blog-details.html'>How can marketing help your business?</a>
                                                </h3>
                                                <ul class="post-meta nav-x ft-tertiary justify-center gap-1 fs-7 text-gray-400 dark:text-gray-300 d-none lg:d-flex">
                                                    <li>
                                                        <div class="hstack gap-narrow ft-tertiary ">
                                                            <img src="./assets/images/avatars/06.png" alt="Allen" class="w-24px h-24px rounded-circle me-narrow">
                                                            <a href="page-author.html" class="text-none fw-bold text-dark dark:text-white">Allen</a>
                                                        </div>
                                                    </li>
                                                    <li class="opacity-50">•</li>
                                                    <li>
                                    ...
                                    <div>
                                        <article class="post type-post panel vstack gap-3 rounded-3 p-2 pb-3 bg-white dark:bg-gray-800">
                                            <a class='position-absolute top-0 ltr:start-0 rtl:end-0 m-3 fs-7 fw-bold text-none z-1 bg-primary text-white py-narrow px-1' href='blog.html' style='border-radius: 8px;'>Business</a>
                                            <figure class="featured-image m-0 rounded ratio ratio-3x2 rounded-2 uc-transition-toggle overflow-hidden">
                                                <img class="media-cover image uc-transition-scale-up uc-transition-opaque" src="./assets/images/blog/img-13.jpg" alt="The ultimate guide to marketing success">
                                                <a class='position-cover' data-caption='The ultimate guide to marketing success' href='blog-details.html'></a>
                                            </figure>
                                            <header class="panel vstack items-center gap-1 lg:gap-2 px-2">
                                                <h3 class="h5 xl:h4 m-0 text-center m-0">
                                                    <a class='text-none' href='blog-details.html'>The ultimate guide to marketing success</a>
                                                </h3>
                                                <ul class="post-meta nav-x ft-tertiary justify-center gap-1 fs-7 text-gray-400 dark:text-gray-300 d-none lg:d-flex">
                                                    <li>
                                                        <div class="hstack gap-narrow ft-tertiary ">
                                                            <img src="./assets/images/avatars/01.png" alt="Kevin" class="w-24px h-24px rounded-circle me-narrow">
                                                            <a href="page-author.html" class="text-none fw-bold text-dark dark:text-white">Kevin</a>
                                                        </div>
                                                    </li>
                                                    <li class="opacity-50">•</li>
                                                    <li>
                            ...
                            <a class='uc-link fw-bold d-inline-flex items-center gap-narrow' href='blog.html'>
