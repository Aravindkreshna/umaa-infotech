                    ...
                    <div class="section-inner panel">
                        <div class="row child-cols-12 lg:child-cols-6 items-center g-2 lg:g-4" data-anime="targets: >*; translateY: [48, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: anime.stagger(100, {start: 200});">
                            <div class="panel vstack gap-narrow lg:gap-2">
                                <h1 class="fs-6 fw-bold text-muted">TallyPrime Server – Centralized Accounting for Your Business</h1>
                                <p class="h2 md:h1 lg:display-6 xl:display-3 xl:mb-2">TallyPrime Server</p>
                            </div>
                            <div class="panel">
                                <h2 class="fs-6 lg:fs-5 xl:fs-4 text-muted">Enable secure, fast, and multi-user access to your TallyPrime data. Collaborate seamlessly across teams, manage accounts efficiently, and scale your business with a centralized server solution.</h2>
                ...
                <div class="container max-w-xl">
                    <div class="section-inner panel max-w-800px mx-auto">
                        ...
                        <p class="fs-6 lg:fs-5 xl:fs-4 text-muted">
                            TallyPrime Server is a powerful solution that centralizes your accounting operations, allowing multiple users to access and work on the same company data simultaneously. Ideal for growing businesses with multiple departments or locations, it ensures secure, fast, and reliable data management while enhancing collaboration and productivity.
                        </p>
                        <!-- <p class="fs-6 lg:fs-5 xl:fs-4 text-muted">
                ...
                <div class="container sm:max-w-lg xl:max-w-xl">
                    <div class="section-inner panel">
                        <div class="panel vstack items-center gap-2 xl:gap-3 mb-4 lg:mb-8 max-w-650px mx-auto text-center" data-anime="onview: -100; targets: >*; translateY: [48, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: anime.stagger(100, {start: 200});">
                            <h2 class="h4 lg:h4 xl:h4 m-0">TallyPrime Server – Secure, Centralized Accounting</h2>
                            <p class="fs-6 lg:fs-5 xl:fs-4 text-muted">Collaborate in real-time, manage accounts efficiently, and scale your business with a centralized server solution.</p>
                        </div>
                                        ...
                                        <div class="panel vstack justify-center gap-4 h-100">
                                            <div>
                                                <div class="panel vstack gap-2">
                                                    ...
                                                    <h3 class="h4 lg:h3 m-0">Multi-User Capability & Data Security with <span class="text-blue">TallyPrime Server</span></h3>
                                                    <p class="fs-6 lg:fs-5 opacity-70 dark:opacity-80">TallyPrime Server enables multiple users to work on the same company data simultaneously, improving collaboration and boosting productivity across teams. Advanced security features—including user authentication, role-based access control, and encryption—ensure that your sensitive financial data remains fully protected. <br><br> <b>Key-Benefits:</b>
                                                        <ul class="fs-6 lg:fs-5 opacity-70 dark:opacity-80">
                                                            <li>Enhance productivity and team collaboration</li>
                                                            <li>Implement strong security with role-based access control</li>
                                                            <li>Safeguard critical financial information with robust protection</li>
                                                        </ul>
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="panel vstack justify-center gap-4 h-100">
                                            <div>
                                                <div class="panel vstack gap-2">
                                                    ...
                                                    <h3 class="h6 lg:h3 m-0">Remote Access, Data Backup & Recovery with <span class="text-blue">TallyPrime Server</span></h3>
                                                    <p class="fs-6 lg:fs-5 opacity-70 dark:opacity-80">TallyPrime Server ensures your financial data is always protected with automated backups and efficient recovery options, minimizing the risk of data loss. Even in case of hardware issues, your data can be restored quickly. Additionally, remote access allows employees to work from anywhere, ensuring real-time collaboration across teams and locations.<br><br> <b>Key-Benefits:</b>
                                                        <ul class="fs-6 lg:fs-5 opacity-70 dark:opacity-80">
                                                            <li>Automatic data backup to safeguard critical information</li>
                                                            <li>Quick data recovery in case of hardware failures</li>
                                                            <li>Remote access for seamless team collaboration</li>
                                                        </ul>
                                                    </p>
                                        ...
                                        <div class="panel vstack justify-center gap-4 h-100">
                                            <div>
                                                <div class="panel vstack gap-2">
                                                    ...
                                                    <h3 class="h4 lg:h3 m-0">Integration, Audit Trail & High Performance with <span class="text-blue">TallyPrime Server</span></h3>
                                                    <p class="fs-6 lg:fs-5 opacity-70 dark:opacity-80">TallyPrime Server seamlessly integrates with other business applications and systems to streamline workflows and enable efficient data exchange. Its robust audit trail feature allows administrators to track user activities, ensuring accountability and transparency. Optimized for high performance, TallyPrime Server handles multiple users simultaneously while maintaining smooth and efficient operations.<br><br> <b>Key-Benefits:</b>
                                                        <ul class="fs-6 lg:fs-5 opacity-70 dark:opacity-80">
                                                            <li>Enhance user accountability with detailed audit trails</li>
                                                            <li>High-performance optimization for fast, reliable operations</li>
                                                            <li>Seamless workflow and data integration across applications</li>
                                                        </ul>
                                                    </p>
                                                </div>
                                            </div>
