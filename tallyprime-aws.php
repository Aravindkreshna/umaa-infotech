                    ...
                    <div class="section-inner panel">
                        <div class="row child-cols-12 lg:child-cols-6 items-center g-2 lg:g-4" data-anime="targets: >*; translateY: [48, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: anime.stagger(100, {start: 200});">
                            <div class="panel vstack gap-narrow lg:gap-2">
                                <h1 class="fs-6 fw-bold text-muted">TallyPrime Powered by AWS: Advanced Cloud Accounting for Growing Businesses</h1>
                                <p class="h2 md:h1 lg:display-6 xl:display-3 xl:mb-2">TallyPrime Powered by AWS</p>
                            </div>
                            <div class="panel">
                                <h2 class="fs-6 lg:fs-5 xl:fs-4 text-muted">Experience lightning-fast performance, enhanced security, and scalable operations for your business with cloud-powered Tally Prime.</h2>
        ...
        <div class="section panel overflow-hidden mx-2 lg:mx-0 mt-n3 lg:mt-n6">
            <div class="container max-w-xl">
                <div data-anime="translateY: [24, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: 500;">
                    <img class="w-full rounded-2" src="./assets/images/services/tallyoncloud/umaainfotech-tally-on-cloud.webp" alt="hero-page-service-detail">
                </div>
            </div>
        </div>
            ...
            <div class="section-outer panel py-4 md:py-6 xl:py-9">
                <div class="container max-w-xl">
                    <div class="section-inner panel max-w-800px mx-auto">
                        <h3>Tally Prime Powered by AWS</h3>
                        <p class="fs-6 lg:fs-5 xl:fs-4 text-muted">
                            Tally Prime Powered by AWS brings together the robust business management capabilities of Tally Prime with the unmatched scalability, security, and performance of Amazon Web Services. This cloud-powered solution allows businesses to access Tally Prime anytime, anywhere, ensuring seamless operations, real-time data access, and enhanced collaboration across teams. By leveraging AWS’s reliable infrastructure, Tally Prime delivers faster processing, high availability, and secure handling of your critical business data, empowering businesses to focus on growth without worrying about IT constraints.
                        </p>
                        <!-- <p class="fs-6 lg:fs-5 xl:fs-4 text-muted">
                ...
                <div class="container sm:max-w-lg xl:max-w-xl">
                    <div class="section-inner panel">
                        <div class="panel vstack items-center gap-2 xl:gap-3 mb-4 lg:mb-8 max-w-650px mx-auto text-center" data-anime="onview: -100; targets: >*; translateY: [48, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: anime.stagger(100, {start: 200});">
                            <h2 class="h4 lg:h4 xl:h4 m-0">Everything You Need, All in One Place</h2>
                            <p class="fs-6 lg:fs-5 xl:fs-4 text-muted">The combined expertise of Tally and AWS ensures Tally Prime works seamlessly for you—anytime, anywhere.</p>
                        </div>
                                        ...
                                        <div class="panel vstack justify-center gap-4 h-100">
                                            <div>
                                                <div class="panel vstack gap-2">
                                                    ...
                                                    <h3 class="h4 lg:h3 m-0">Cloud-Based Infrastructure</h3>
                                                    <p class="fs-6 lg:fs-5 opacity-70 dark:opacity-80">Tally Prime Powered by AWS harnesses the power of AWS’s robust cloud infrastructure, delivering scalable and reliable computing resources for your Tally applications. Benefit from highly secure data centers, advanced protection against potential threats, and seamless operations even during peak times. Access your business data anytime, anywhere—without compromise.<br><br>
                                                        <ul class="fs-6 lg:fs-5 opacity-70 dark:opacity-80">
                                                            <li><b>Advanced Data Security –</b> Keep your critical business data safe with enterprise-grade security.</li>
                                                            <li><b>Disaster Recovery Ready –</b> Minimize downtime with reliable backup and recovery options.</li>
                                                            <li><b>Scalable Resources –</b> Adjust computing power on demand to match your business needs.</li>
                                                        </ul>
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="panel vstack justify-center gap-4 h-100">
                                            <div>
                                                <div class="panel vstack gap-2">
                                                    ...
                                                    <h3 class="h6 lg:h3 m-0">Global Accessibility & High Availability</h3>
                                                    <p class="fs-6 lg:fs-5 opacity-70 dark:opacity-80">With Tally Prime Powered by AWS, your team can access business data from anywhere with an internet connection, enabling seamless remote work. AWS ensures high availability, keeping Tally Prime running even during hardware failures or disruptions. Protect sensitive financial information with advanced security measures such as encryption, access controls, and compliance certifications.<br><br>
                                                        <ul class="fs-6 lg:fs-5 opacity-70 dark:opacity-80">
                                                            <li><b>Access Anywhere, Anytime –</b> Empower your team with flexible remote access.</li>
                                                            <li><b>Reliable During Disruptions –</b> Maintain uninterrupted operations even during hardware failures.</li>
                                                            <li><b>Advanced Security –</b> Safeguard critical financial data with encryption and strict access controls.</li>
                                                        </ul>
                                                    </p>
                                        ...
                                        <div class="panel vstack justify-center gap-4 h-100">
                                            <div>
                                                <div class="panel vstack gap-2">
                                                    ...
                                                    <h3 class="h4 lg:h3 m-0">Backup & Disaster Recovery</h3>
                                                    <p class="fs-6 lg:fs-5 opacity-70 dark:opacity-80">Tally Prime Powered by AWS ensures your business data is protected with robust backup and disaster recovery capabilities, enabling quick restoration in case of data loss or system failures. The cloud integration allows you to scale resources up or down seamlessly, keeping performance consistent as your business grows. AWS optimization tools monitor and adjust resources to maximize efficiency, reducing IT complexity and overhead.<br><br>
                                                        <ul class="fs-6 lg:fs-5 opacity-70 dark:opacity-80">
                                                            <li><b>Data Protection & Rapid Recovery –</b> Safeguard your critical business information.</li>
                                                            <li><b>Optimized Performance –</b> Continuously monitor and fine-tune resources for efficiency.</li>
                                                            <li><b>Flexible & Low IT Burden –</b> Scale effortlessly while minimizing infrastructure management.</li>
                                                        </ul>
                                                    </p>
                                                </div>
                                            </div>
