                    ...
                    <div class="section-inner panel">
                        <div class="row child-cols-12 lg:child-cols-6 items-center g-2 lg:g-4" data-anime="targets: >*; translateY: [48, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: anime.stagger(100, {start: 200});">
                            <div class="panel vstack gap-narrow lg:gap-2">
                                <h1 class="fs-6 fw-bold text-muted">Powerful Upgrades and Connected Business Services for Fast-Growing Companies</h1>
                                <p class="h2 md:h1 lg:display-6 xl:display-3 xl:mb-2">Tally Software Solutions</p>
                            </div>
                            <div class="panel">
        ...
        <div class="section panel overflow-hidden mx-2 lg:mx-0 mt-n3 lg:mt-n6">
            <div class="container max-w-xl">
                <div data-anime="translateY: [24, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: 500;">
                    <img class="w-full rounded-2" src="./assets/images/services/tallysoftwaresolutions/umaainfotech-tally-software-solutions.jpg" alt="hero-page-service-detail">
                </div>
            </div>
        </div>
            ...
            <div class="section-outer panel py-4 md:py-6 xl:py-9">
                <div class="container max-w-xl">
                    <div class="section-inner panel max-w-800px mx-auto">
                        <h3>What is TSS?</h3>
                        <h4>Your Gateway to Smarter Business Management</h4>
                        <p class="fs-6 lg:fs-5 xl:fs-4 text-muted">
                            Tally Software Services (TSS) extends the power of TallyPrime by offering continuous updates, compliance support, and connected features. From GST filing and online data exchange to banking integration and real-time reports, TSS ensures your business runs seamlessly while keeping you ahead of regulatory and technology changes.
                        </p>
                        <!-- <p class="fs-6 lg:fs-5 xl:fs-4 text-muted">
                ...
                <div class="container sm:max-w-lg xl:max-w-xl">
                    <div class="section-inner panel">
                        <div class="panel vstack items-center gap-2 xl:gap-3 mb-4 lg:mb-8 max-w-650px mx-auto text-center" data-anime="onview: -100; targets: >*; translateY: [48, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: anime.stagger(100, {start: 200});">
                            <h2 class="h3 lg:h4 xl:h3 m-0">key benefits of Tally Software Service</h2>
                        </div>
                        <div class="sticky-scene panel vstack gap-4 sm:gap-6 xl:gap-8">
                            <div class="feature-item panel px-3 lg:px-4 py-4 rounded-2 bg-secondary dark:bg-gray-800" data-anime="onview: -200; translateY: [48, 0]; opacity: [0, 1]; easing: spring(1, 80, 10, 0); duration: 450; delay: 100;">
                                <div class="row child-cols col-match justify-between g-4 lg:g-8 xl:g-10">
                                    ...
                                    <div class="order-1 lg:order-0 col-12 sm:col-6">
                                            ...
                                            <div class="panel">
                                                <ul class="uc-accordion gap-1 max-w-md mx-auto" data-uc-accordion="targets: > li; multiple: false;">
                                                    <li class="panel p-2 md:p-3 lg:p-4 bg-secondary dark:bg-tertiary-700 rounded-1-5 uc-open ">
                                                        <a class="uc-accordion-title h6 md:h5 lg:h5 fw-medium ltr:pe-4 rtl:ps-4" href="#">Free Upgrades for Smarter Business Management</a>
                                                        <div class="uc-accordion-content lg:fs-5 opacity-70">
                                                            <p>TallyPrime provides free product updates and major releases—keeping your business compliant, future-ready, and in sync with the latest statutory and technological changes.</p>
                                                        </div>
                                                    </li>
                                                    <li class="panel p-2 md:p-3 lg:p-4 bg-secondary dark:bg-tertiary-700 rounded-1-5">
                                                        <a class="uc-accordion-title h6 md:h5 lg:h5 fw-medium ltr:pe-4 rtl:ps-4" href="#">Seamless Connected GST Experience with TallyPrime</a>
                                                        <div class="uc-accordion-content lg:fs-5 opacity-70">
                                                            <p><b>TallyPrime simplifies GST compliance by integrating filing, e-invoicing, reconciliation, and e-way bill generation into one connected solution—eliminating the need to visit the GST portal.</b><br>
                                                                With TallyPrime’s connected IMS solution, you can: <br><br>
                                                            <ul>
                                                                <li>Download, reconcile, and take actions (Accept, Reject, or Pending) directly within TallyPrime, keeping your books and IMS dashboard in sync.</li>
                                                                <li>Upload GSTR-1 and GSTR-3B instantly and file GSTR-1 without leaving TallyPrime.</li>
                                                                <li>Auto-reconcile GSTR-2A, GSTR-2B, GSTR-3B, and GSTR-1 across multiple GSTINs, returns, and periods.</li>
                                                                <li>Generate e-invoices and e-way bills instantly for single, selective, or bulk invoices—without changing your invoicing process.</li>
                                                                <li>Create supplier and customer ledgers by fetching GST details from the portal, individually or in bulk via Excel import.</li>
                                                                <li>Verify GSTIN status and check return filing history of your parties directly within TallyPrime.</li>
                                                            </ul></p>
                                                        </div>
                                                    </li>
                                                    <li class="panel p-2 md:p-3 lg:p-4 bg-secondary dark:bg-tertiary-700 rounded-1-5 ">
                                                        <a class="uc-accordion-title h6 md:h5 lg:h5 fw-medium ltr:pe-4 rtl:ps-4" href="#">Online Access to Business Reports & Data</a>
                                                        <div class="uc-accordion-content lg:fs-5 opacity-70">
                                                            <p>Stay connected to your business, wherever you are. With TallyPrime and Tally.NET services, you get secure, real-time access to critical business reports from any device—mobile, tablet, or desktop.
                                                                <ul>
                                                                    <li>Access key reports like Bills Receivable & Payable, Stock Summary, Sales & Purchase Registers, Profit & Loss, and Balance Sheet anytime.</li>
                                                                    <li>View, download, and share reports or invoices seamlessly.</li>
                                                                    <li>Make faster, smarter decisions with on-the-go insights.</li>
                                                                    <li>Remotely connect to your TallyPrime via our secure Tally.NET server.</li>
                                                                </ul>
                                                            </p>
                                                        </div>
                                                    </li>
                                                    <li class="panel p-2 md:p-3 lg:p-4 bg-secondary dark:bg-tertiary-700 rounded-1-5 ">
                                                        <a class="uc-accordion-title h6 md:h5 lg:h5 fw-medium ltr:pe-4 rtl:ps-4" href="#">Seamless Online Data Synchronization with TallyPrime</a>
                                                        <div class="uc-accordion-content lg:fs-5 opacity-70">
                                                            <p>Managing books across multiple branches, factories, or warehouses has never been easier. TallyPrime’s data synchronization lets you consolidate and control your financial and operational data effortlessly.
                                                                <ol>
                                                                    <li>Sync and consolidate data across all locations with a single click.</li>
                                                                    <li>Choose what data to sync and when, with full control over the process.</li>
                                                                    <li>Perform on-demand synchronization without requiring live connections.</li>
                                                                    <li>Gain complete visibility with consolidated reports on finances, stock, and performance.</li>
                                                                </ol>
                                                            </p>
                                                        </div>
                                                    </li>
                        ...
                        <div class="row child-cols-12 col-match g-4">
                            ...
                            <div>
                                <div class="panel">
                                    <ul class="uc-accordion gap-1 max-w-md mx-auto" data-uc-accordion="targets: > li; multiple: false;">
                                        <li class="panel p-2 md:p-3 lg:p-4 bg-secondary dark:bg-tertiary-700 rounded-1-5 uc-open">
                                            <a class="uc-accordion-title h6 md:h5 lg:h5 fw-medium ltr:pe-4 rtl:ps-4" href="#">What is the validity of TSS?</a>
                                            <div class="uc-accordion-content lg:fs-5 opacity-70">
                                                <p>
                                                    When you renew your annual TSS subscription, you receive a 12-month validity. You can also opt for a 2-year TSS subscription which will grant you access for a full 24 months.
                                                </p>
                                            </div>
                                        </li>
                                        <li class="panel p-2 md:p-3 lg:p-4 bg-secondary dark:bg-tertiary-700 rounded-1-5 ">
                                            <a class="uc-accordion-title h6 md:h5 lg:h5 fw-medium ltr:pe-4 rtl:ps-4" href="#">
                                                Can I renew the subscription before the end of the validity period?</a>
                                            <div class="uc-accordion-content lg:fs-5 opacity-70">
                                                <p>Yes, you can renew TSS subscription before the end of the validity period. You can now choose to renew it for 1 year or opt for a 2-year validity for a 10% discount.</p>
                                            </div>
                                        </li>
                                        <li class="panel p-2 md:p-3 lg:p-4 bg-secondary dark:bg-tertiary-700 rounded-1-5 ">
                                            <a class="uc-accordion-title h6 md:h5 lg:h5 fw-medium ltr:pe-4 rtl:ps-4" href="#">
                                                Can I renew TSS for more than one year?
                                            </a>
                                            <div class="uc-accordion-content lg:fs-5 opacity-70">
                                                <p>
                                                    Yes. You can now renew your TSS subscription for up to 2 years for a 10% discount.
                                                </p>
                                            </div>
                                        </li>
                                        <li class="panel p-2 md:p-3 lg:p-4 bg-secondary dark:bg-tertiary-700 rounded-1-5 ">
                                            <a class="uc-accordion-title h6 md:h5 lg:h5 fw-medium ltr:pe-4 rtl:ps-4" href="#">
                                                I have purchased TallyPrime. Do I need to purchase TSS too?
                                            </a>
                                            <div class="uc-accordion-content lg:fs-5 opacity-70">
                                                <p>
                                                    No. With every new license of TallyPrime, you will get TSS validity of 12 months.
                                                </p>
                                            </div>
                                        </li>
                                    </ul>
