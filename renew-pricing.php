                ...
                <div class="container max-w-xl">
                    <div class="section-inner panel mt-2 sm:mt-4 lg:mt-0">
                        <div class="vstack items-center gap-3 lg:gap-4 mb-4 sm:mb-6 lg:mb-8 max-w-750px mx-auto text-center" data-anime="targets: >*; translateY: [48, 0]; opacity: [0, 1]; easing: spring(1, 80, 10, 0); duration: 450; delay: anime.stagger(100, {start: 200});">
                            <h1 class="h2 sm:h1 lg:display-6 xl:display-5 m-0">Tally Software Services (TSS) Pricing & Renewal Plans.</h1>
                            <p class="fs-6 xl:fs-5 text-dark dark:text-white text-opacity-70">Already using TallyPrime? Renew your TSS subscription now and continue enjoying seamless updates, connected services, and remote access.</p>
                                ...
                                <div class="row child-cols-12 sm:child-cols-6 xl:child-cols-4 col-match justify-center g-2 lg:g-4" data-anime="onview: -100; targets: >*; translateY: [48, 0]; opacity: [0, 1]; easing: spring(1, 80, 10, 0); duration: 450; delay: anime.stagger(100, {start: 400});">
                                    <div>
                                        ...
                                        <div class="panel text-center">
                                                ...
                                                <p class="desc dark:text-whiteopacity-70 dark:opacity-80">Single user edition for <br>
                                                standalone PCs</p>
                                            </div>
                                            <div class="panel text-center">
                                                <div class="panel vstack gap-narrow">
                                                    <h5 class="title h3 sm:h2 m-0 dark:text-white">INR 4,500<span class="h6">.00</span></h5>
                                                    <span class="fs-7 opacity-70 ">per year. <br> <span class="h6 text-blue">Single Member</span> <br> +18% GST (INR 810)</span>
                                    ...
                                    <div>
                                        <div class="tier panel vstack gap-2 xl:gap-4 px-3 py-4 sm:p-4 lg:p-6 rounded lg:rounded-2 bg-secondary dark:bg-gray-800">
                                            ...
                                            <div class="panel text-center">
                                                ...
                                                <p class="desc dark:text-whiteopacity-70 dark:opacity-80 ">Unlimited multi-user edition For <br> multiple PCs</p>
                                            </div>
                                            <div class="panel text-center">
                                                <div class="panel vstack gap-narrow">
                                                    <h5 class="title h3 sm:h2 m-0 dark:text-white">INR 13,500<span class="h6">.00</span></h5>
                                                    <span class="fs-7 opacity-70 ">per year. <br> <span class="h6 text-blue">Single Member</span> <br> +18% GST (INR 2,430)</span>
                                                    <div class="vstack gap-1 justify-center text-center mt-3">
                                                        <a class='btn btn-md sm:btn-sm lg:btn-md btn-primary text-white' href='contact.php'>Start a free trial</a>
                                                        <span class="fs-7 opacity-70 min-h-24px">No credit card required</span>
                                                    </div>
                                            ...
                                            <!-- <div class="position-absolute bottom-0 ltr:end-0 rtl:start-0 m-2 d-none md:d-block">
                                                <img class="w-100px lg:w-128px d-block dark:d-none" src="./assets/images/template/money.svg" alt="money">
                                                <img class="w-100px lg:w-128px d-none dark:d-block" src="./assets/images/template/money-dark.svg" alt="money-dark">
                                            </div> -->
                                        </div>
                                    </div>
                                    <div>
                                        <div class="tier panel vstack gap-2 xl:gap-4 px-3 py-4 sm:p-4 lg:p-6 rounded lg:rounded-2 bg-secondary dark:bg-gray-800">
                                            <div class="panel text-center">
                                                <h3 class="title h5 sm:h4 dark:text-white">Auditor</h3>
                                                <p class="desc dark:text-whiteopacity-70 dark:opacity-80">For large companies with <br> complex Tool workflows.</p>
                                            </div>
                                            <div class="panel text-center">
                                                <div class="panel vstack gap-narrow">
                                                    <h5 class="title h3 sm:h2 m-0 dark:text-white">INR 6,750<span class="h6">.00</span></h5>
                                                    <span class="fs-7 opacity-70 ">per year. <br> <span class="h6 text-blue">Single Member</span> <br> +18% GST (INR 1,215)</span>
                                                    <div class="vstack gap-1 justify-center text-center mt-3">
                                                        <a class='btn btn-md sm:btn-sm lg:btn-md btn-dark text-white dark:bg-white dark:text-dark dark:hover:bg-secondary' href='contact.php'>Contact sales</a>
